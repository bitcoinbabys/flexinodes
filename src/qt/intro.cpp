...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Flexinodes Core"),
     ...
     * override -datadir in the flexinodes.conf file in the default data directory
     * (to be consistent with flexinodesd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
