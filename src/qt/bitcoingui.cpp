                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Flexinodes-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Flexinodes address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and flexinodes: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Flexinodes Core"), this);
    aboutAction->setStatusTip(tr("Show information about Flexinodes Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Flexinodes"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Flexinodes addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Flexinodes addresses"));
    ...
    openAction->setStatusTip(tr("Open a Flexinodes: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Flexinodes Core help message to get a list with possible Flexinodes command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Flexinodes Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Flexinodes network", "", count));
}
...
{
    QString strTitle = tr("Flexinodes Core"); // default title
