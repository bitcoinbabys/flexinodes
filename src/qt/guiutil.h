...
/** Utility functions used by the FLX Qt UI.
 */
namespace GUIUtil
{
...
// Render FLX addresses in monospace font
...
// Parse "flexinodes:" URI into recipient object, return true on successful parsing
