/* src/config/flexinodes-config.h.  Generated from flexinodes-config.h.in by configure.  */
/* src/config/flexinodes-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "http://bit.flexinodess"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Flexinodes Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Flexinodes Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "flexinodes"
